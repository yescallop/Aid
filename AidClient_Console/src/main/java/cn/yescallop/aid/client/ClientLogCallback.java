...
public class ClientLogCallback implements LogCallback {

    public static final ClientLogCallback INSTANCE;

    public static int logLevel = AV_LOG_INFO;

    static {
        INSTANCE = new ClientLogCallback();
    }

    private ClientLogCallback() {
    }
